...
export default function Main() {
  ...
  const output = [
    ...
    {"speaker": "user", "text": "첫째 아이가 태어난 날은 저에게 깊이 각인된 순간입니다. 와이프가 아이를 낳은 후, 아이를 처음 본 그 순간은 말로 표현할 수 없을 만큼 감동적이었습니다. 또한, 결형식 날도 잊을 수 없는 날입니다. 사랑하는 모든 사람들이 우리를 축복해주러 왔고, 그들과 함께 즐기는 시간은 무척이나 행복했습니다. 아이들과 함께한 첫 가족 여행도 매우 소중한 추억입니다. 해변에서 놀고, 저녁에 바베큐를 하는 등의 시간들이 특히 인상 깊었습니다. 그러나 그 중에서도 아이들이 해변에서 처음으로 파도를 만끽하는 모습을 보는 것이 가장 기억에 남습니다. 그들의 웃음소리는 지금도 귀에 생생하게 들립니다."}
  ];

  // Inline styles for book page effects
  const bookPageStyle = {
    background: 'url("https://img.freepik.com/premium-vector/white-gray-background-with-soft-watercolor-texture_34396-342.jpg")', // Replace with your paper texture image path
  ...
  return (
    <Layout>
      <div className="flex h-full w-full flex-col items-center pt-16 text-2xl" style={bookPageStyle}>
